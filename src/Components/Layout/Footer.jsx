...
<footer className="mt-16">
      ...
      <div className="max-w-screen-lg mx-auto border-none px-4">
        ...
        >
          ...
          <div className='w-full sm:w-1/3 flex flex-row justify-around'>
            <p className="hidden sm:block leading-8 tracking-wide">Privacy Policy</p>
            <a href="https://www.instagram.com/_.kolade._">
                    <img src={Instagram} alt='' style={{width:'35px',height:'35px'}}/>
            </a>
            <a href='https://www.twitter.com/corlard3y'>
                     <img src={Twitter} alt='' style={{width:'35px',height:'35px'}}/>
            </a>
            <a href='https://www.google.com'>
                      <img src={Google} alt='' style={{width:'35px',height:'35px'}}/>
            </a>
            <a href='https://wwww.facebook.com'>
                    <img src={Facebook} alt='' style={{width:'35px',height:'35px'}}/>
            </a>
          </div>
        </section>
      </div>
